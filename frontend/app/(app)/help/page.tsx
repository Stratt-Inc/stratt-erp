    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        >
          ...
          <div>
            <p className="text-sm font-semibold text-foreground">Tour guidé</p>
            <p className="text-xs text-muted-foreground">Relancer la visite</p>
          </div>
        </button>
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-1">Legifrance <ExternalLink size={10} /></p>
          </div>
        </a>
        ...
        >
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground flex items-center gap-1">Schéma officiel <ExternalLink size={10} /></p>
          </div>
        </a>
      </div>
        ...
        {CATEGORIES.map((cat) => (
          <button
            ...
            className={`px-3 py-1.5 rounded-full text-xs font-medium transition-colors ${
              category === cat ? "text-white" : "text-muted-foreground hover:text-foreground"
            }`}
            style={
              category === cat
        ...
        {filtered.map((article) => (
          ...
          >
            ...
            >
              ...
              <ChevronRight
                size={15}
                className={`text-muted-foreground transition-transform shrink-0 ml-2 ${expanded === article.id ? "rotate-90" : ""}`}
              />
            </button>
                  ...
                  <div className="flex gap-1.5 flex-wrap">
                    {article.tags.map((tag) => (
                      <button
                        ...
                        className="px-2 py-0.5 text-xs rounded-full transition-colors text-muted-foreground hover:text-foreground"
